function popolaInfoFilm() {
  ...
  getFilm("i", getParameterByName("id"), true)
    .then((result) => {
      console.log(result);
      ...
      else pValutazione.appendChild(document.createTextNode("NaN"));
  ...
  for (var i = 0; i < arrAct.length; i++) {
    ...
    jQuery
      ...
      .then(function (results) {
        ...
        col.setAttribute(
          "class",
          "col p-2 justify-content-center align-items-center rounded"
        );
